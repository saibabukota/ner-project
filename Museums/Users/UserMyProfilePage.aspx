<%@ Page Language="C#" MasterPageFile="~/Users/UserMasterPage.master" AutoEventWireup="true" CodeFile="UserMyProfilePage.aspx.cs" Inherits="Users_UserMyProfilePage" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellpadding="0" cellspacing="0" class="style1">
        ...
        <tr>
            <td class="style13">
                <asp:Panel ID="Panel2" runat="server" Height="50px" Width="1152px">
                    <asp:GridView ID="gvfill" runat="server" AutoGenerateColumns="False" 
                    onrowcommand="gvfill_RowCommand" Font-Names="Times New Roman" 
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server" Height="457px" Width="1149px">
                    <table cellpadding="0" cellspacing="0" class="style1" 
                        
                        style="height: 292px; width: 97%; font-family: 'Times New Roman'; font-size: large;">
                        <tr>
