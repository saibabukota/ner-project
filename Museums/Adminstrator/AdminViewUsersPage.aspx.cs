...
public partial class Adminstrator_AdminViewUsersPage : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from tblMasterUsers", con);
        DataTable dt = new DataTable();
        da.Fill(dt);
        gvfill.DataSource = dt;
        gvfill.DataBind();
    ...
    {
        Response.Redirect("AdminViewUsersPage.aspx");
    }
    protected void gvfill_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gvfill.PageIndex = e.NewPageIndex;
        fillgrid();
    }
}
