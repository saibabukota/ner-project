<%@ Page Language="C#" MasterPageFile="~/Adminstrator/AdiministratorMasterPage.master" AutoEventWireup="true" CodeFile="AdminViewMuseumsPage.aspx.cs" Inherits="Adminstrator_AdminViewMuseumsPage" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td class="style3" align="center">
                <asp:Panel ID="Panel2" runat="server" Height="228px" Width="665px">
    ...
    onrowcommand="GridView1_RowCommand" AllowPaging="True" 
        ...
        <tr>
            <td class="style3" align="center">
                <asp:Panel ID="Panel1" runat="server" Height="204px" Width="642px">
                    <table cellpadding="0" cellspacing="0" class="style2">
                        <tr>
                            <td>
                                Museum Name</td>
